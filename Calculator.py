...
Display = Entry(root,font=("arial",30,"bold"), fg = "white",
                bg = "blue", justify = "right",bd = 50,textvariable = txt_input)
...
btnC = Button(root,padx=30,pady=15,bd=8,fg='black',font=("arial",30,"bold"),
              text="C",bg="blue",command = Clear).grid(row=1,column=3)
#========== Row 2 ==========
...
btn8plus = Button(root,padx=33,pady=15,bd=8,fg='black',font=("arial",30,"bold"),
...
btnequals = Button(root,padx=95,pady=15,bd=8,fg='black',font=("arial",30,"bold"),
              text="=",bg="blue",command = Equals).grid(row=5,column=0,columnspan=2)
